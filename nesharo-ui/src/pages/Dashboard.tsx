...
const insights = [
  {
    type: "warning",
    icon: "⚠️",
    text: "لحن محتوای شما در ۳۰ روز اخیر ۴۲٪ تغییر کرده — ثبات پیام برند آسیب دیده است.",
  },
  {
    type: "tip",
    icon: "💡",
    text: "پست‌های کاروسل شما ۳.۲× بیشتر از ریلز تعامل دارند. تمرکز روی کاروسل توصیه می‌شود.",
  },
  {
    type: "success",
    icon: "✅",
    text: "نرخ تعامل هفته گذشته ۱۸٪ افزایش یافت. هوک‌های سوالی عملکرد بهتری داشتند.",
  },
  {
    type: "warning",
    icon: "⚠️",
    text: "بیوی پیج شما جایگاه مشخصی برای مخاطب ایجاد نمی‌کند — بهبود فوری توصیه می‌شود.",
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="absolute text-center">
        <div
          className="font-mono font-bold text-4xl gradient-text"
          style={{ lineHeight: 1 }}
        >
          {score}
        </div>
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div
            className="text-sm font-medium mb-4 w-full"
            style={{ color: "var(--muted-foreground)" }}
          >
            Brand Score
          </div>
              ...
              <div key={cat.label}>
                ...
                >
                  <div
                    ...
                    style={{
                      width: `${cat.score}%`,
                      background: `linear-gradient(90deg, ${cat.color}, #4f46e5)`,
                    }}
                  />
                </div>
              </div>
