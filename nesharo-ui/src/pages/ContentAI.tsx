...
const calendar = [
  ...
  { day: "سه‌شنبه", type: "—", title: "—", status: "rest" },
  {
    day: "چهارشنبه",
    type: "ریلز",
    title: "قبل vs بعد لوگو",
    status: "scheduled",
  },
  {
    day: "پنجشنبه",
    type: "استوری",
    title: "پشت‌صحنه پروژه",
    status: "scheduled",
  },
...
export default function ContentAI() {
  const [captionInput, setCaptionInput] = useState(
    "امروز یه لوگو طراحی کردم که خیلی خوشم اومد. می‌خوام باهاتون share کنم.",
  )
  const [improved, setImproved] = useState(false)
  const [activeTab, setActiveTab] = useState<"ideas" | "calendar" | "caption">(
    "ideas",
  )
            ...
            {calendar.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {item.status !== "rest" && (
                      <span className="tag badge-violet text-xs">
                        {item.type}
                      </span>
                    )}
                    <span
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            >
              نسخه بهبودیافته
              {improved && (
                <span className="tag badge-violet mr-2 text-xs">آماده</span>
              )}
            </label>
            <div
              ...
              style={{
                ...
                border: `1px solid ${
                  improved ? "rgba(124,58,237,0.25)" : "var(--border)"
                }`,
                height: 220,
                overflow: "auto",
                color: improved
            ...
            >
              {improved
                ? improvedCaption
                : "کپشن خود را بنویسید و دکمه بهبود را بزنید..."}
            </div>
            {improved && (
